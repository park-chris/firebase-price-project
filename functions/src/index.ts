...
let updateLastDate = "19991212";

export const scheduledUpdateTask = functions
...
async function fetchDataFromOpenAPI(): Promise<number> {
  ...
  try {
    ...
    let apiUrl = `http://openAPI.seoul.go.kr:8088/42684a64517a787a3435474a596e46/json/ListNecessariesPricesService/${startIndex}/${endIndex}/`;
    ...
    do {
      ...
      apiUrl = `http://openAPI.seoul.go.kr:8088/42684a64517a787a3435474a596e46/json/ListNecessariesPricesService/${startIndex}/${endIndex}/`;
